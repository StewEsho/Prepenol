...
M.class = class("Turret", enemyBase.BaseEnemy);
M.description = "Locking in on target"

function M.class:__init(_x, _y, newIndex)
  self.x = _x;
  self.y = _y;
  enemyBase.BaseEnemy.__init(self, 3, self.x, self.y, 260, 300, math.random(0, 359), "img/sprites/turret.png", "Turret", description, 0, newIndex);
